//Tela de formulário login e cadastro
...
class Auth extends Component {
    constructor(props) {
        super(props)
        this.state = {loginMode: true} //modo de login = false, mostra o modo de cadastro
    }

    //Muda o modo do formulário, login ou cadastro
    changeMode() {
        this.setState({ loginMode: !this.state.loginMode })
    }

    //Envio do form dependendo do modo
    onSubmit(values) {
...
//Armazena na variável o componente já decorado com reduxForm
